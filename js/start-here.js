  ...
  function changeSeason(season) {
    switch (season) {
      ...
      default:
        ...
        $("#season-description").html("Whatever the weather, we’ve got your style covered. Larry Browser brings seasonal looks that fit every forecast. Tap into fashion that flows with the calendar. 🌦️👕");
